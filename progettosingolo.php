...
// Imposta la pagina 
$page = isset($_GET['page']) ? $_GET['page'] : 'progettosingolo';
...
<div class="container">
        ...
        <div class="project">
            <img src="img/webdesigner.jpg" alt="webdesigner">
            <h3>WEB DESIGNER</h3>
        ...
        <div class="project">
            <img src="img/progetto.jpg" alt="progetto">
    ...
    <div class="project">
        <img src="img/progetto2.jpg" alt="progetto">
...
<div class="project">
    <img src="img/progetto3.jpg" alt="progetto">
...
<div class="project">
    <img src="img/progetti4.jpg" alt="progetto">
    <h3>Quarto Progetto</h3>
    <p><?php echo $page_data['contenuto']; ?></p>
